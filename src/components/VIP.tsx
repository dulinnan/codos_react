                ...
                <div className="container justify-content-center">
                    <div className="row mb-5 justify-content-center">
                        <div className="col-lg-8 col-md-12">
                            <h6 className="mb-5 mt-5" style={{color: "#F11b3f"}}>
                                感谢您对CJC Markets
                            ...
                            <p className="col-lg-12">
                                4. 赠金有效期为三个月，从申请赠金起开始计算。当赠金到期时，CJC Markets 有权利取走赠金。
                            </p>
                            <p className="col-lg-12">
                            ...
                            <p className="col-lg-12 mt-4">
                                8. 客户交易量达标后请自行发邮件至
                                <a href="mailto:client@cjcmarkets.com">client@cjcmarkets.com</a>
                                申领赠金；交易量以 CJC Markets 核实后为准。
                            </p>
                            <Contacts />
                            <p className="col-lg-12" style={{fontSize: "10px"}}>
                                您参与此次活动即确认您知悉并将遵守我们的活动条款。
                                <br />
                                本活动不能与其他活动叠加，活动最终解释权归 CJC Markets 所有。
                                <br />
