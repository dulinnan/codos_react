...
export default {
    ...
    qna: {
        ...
        invalidAccountAns:
            "Usually, this is caused by the server selection error or wrong password. ‘CarrickJustCapital-RS-S4-Demo’ is for the demo account server and ‘CarrickJustCapital-RS-S4-Main’ is for Standard account server. \nPlease choose the right server. Initial password must be comprised of both letters and numbers. Please make sure type in the correct password or copy and paste from the notification email. ",
    ...
    footer: {
        ...
        license: "License",
        licenseMessage:
            "CODOS  is registered in New Zealand (NZBN number: 9429046269300) and has a Derivatives Issuer License issued by the Financial Markets Authority. FSPR registration number 569807.",
        disclaimer: "Disclaimer",
        disclaimerMessage:
            "Nothing in this website shall be construed as financial advice or an invitation to buy or sell a product. CODOS  does not guarantee the accuracy of timeliness of any information on this website.",
        reminder: "Reminder",
        reminderMessage:
